...
140	Upward Plank	Pūrvottānāsana	Purvottanasana	From Staff (Daṇḍāsana) place the hands on the floor about one foot behind the hips with the fingertips pointed forward towards the hips.  On an inhale press through the hands and feet to lift the hips as high as possible.  Keep the inner line of the feet together and seal them into the mat as much as possible.  Relax the head back and gaze at the tip of your nose.	Intermediate	\N	Strengthens the arms, the wrists, and the legs.  Stretches the shoulders, the chest, and the front ankles.	static/img/plank_upward.png	\N	Staff	Table	{"169": 1}	'back':65 'behind':16 'daṇḍāsana':6 'feet':35,50 'fingertip':21 'floor':12 'foot':15 'forward':23 'gaze':67 'hand':9,33 'head':64 'high':41 'hip':18,26,39 'inhal':29 'inner':46 'keep':44 'lift':37 'line':47 'mat':57 'much':59 'nose':73 'one':14 'place':7 'plank':2A 'point':22 'possibl':43,61 'press':30 'purvottanasana':3C 'relax':62 'seal':53 'staff':5 'tip':70 'togeth':51 'toward':24 'upward':1A
